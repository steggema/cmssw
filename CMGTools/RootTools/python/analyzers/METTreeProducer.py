...
class METTreeProducer( TreeAnalyzerNumpy ):
    ...
    def process(self, iEvent, event):
        ...
        fill(tr, 'ngoodjets', event.nGoodJets)
        fill(tr, 'nPUjets', event.nPUJets)

        fill(tr, 'ngoodvertices', len(event.goodVertices))
        fill(tr, 'nvertices', len(event.vertices))

        fill(tr, 'sumPtPV', event.sumPtPV)
        fill(tr, 'sumPtPU', event.sumPtPU)
        fill(tr, 'sumPtNeutral', event.sumPtNeutral)
        fill(tr, 'sumPtPhotons', event.sumPtPhotons)
        fill(tr, 'sumPtAll', event.sumPtAll)
